...
Return ONLY a JSON object matching this exact schema:
{
  ...
  "category": "Primary category (e.g. 'GVT / PGVT (Glazed Vitrified)', 'Porcelain Tiles', 'Ceramic Wall Tiles', 'Handmade & Subway Tiles', 'Large Format Slabs / Countertops', 'Sanitaryware', 'Tile Adhesives', 'Manufacturer', 'Distributor', 'Exporter / Importer')",
  "categories": ["Array of 1 to 4 matching categories, e.g. 'Handmade & Subway Tiles', 'GVT / PGVT (Glazed Vitrified)', 'Large Format Slabs / Countertops', 'Tile Manufacturer / Factory'"],
